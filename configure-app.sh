...
read portalTeamId
# echo -n "CodePush Deployment Key Code Prod: "
# read CodePushDeploymentKeyCodeProd
# echo -n "CodePush Deployment Key Code Stage "
# read CodePushDeploymentKeyCodeStage
...
# echo "CodePushDeploymentKeyCodeStage: $CodePushDeploymentKeyCodeStage"
# echo "CodePushDeploymentKeyCodeProd: $CodePushDeploymentKeyCodeProd"
